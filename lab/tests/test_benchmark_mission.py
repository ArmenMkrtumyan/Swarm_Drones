"""Smoke tests for lab.missions.benchmark_mission.
...
from lab.missions.benchmark_mission import (
    aggregate_per_wp,
    analyze_run,
...
from lab.missions.dsl import HomePosition, load as load_mission
