"""Regression tests for lab.control.metrics.
...
from lab.common.logging import load
from lab.control.metrics import compute_metrics, find_hover_window


REPO = Path(__file__).resolve().parents[2]   # Swarm_Drones/ (lab/tests/<file>.py is 2 levels deep)
