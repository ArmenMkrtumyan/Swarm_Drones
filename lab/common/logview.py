...
Usage:
    python -m lab.common.logview LOG.jsonl
    python -m lab.common.logview LOG.jsonl --interval 2
    python -m lab.common.logview LOG.jsonl --gate wind5
    python -m lab.common.logview LOG.jsonl --full
...
from lab.control.metrics import compute_metrics
