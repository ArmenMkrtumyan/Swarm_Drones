...
Usage:
    ...
    lab/rl/.rl_venv/Scripts/python.exe -m lab.rl.aggregate_compare \\
...
log = logging.getLogger("lab.rl.aggregate")
...
def _build_report(raw, runs, curves, eval_results, total_steps, bin_size, fig_path):
    ...
    lines.append(f"Comparison of the algorithms {', '.join(algos)} on the "
                 "HoverPretrain environment from the F450 lab. All algorithms are "
    ...
    lines.append("lab/rl/.rl_venv/Scripts/python.exe -m lab.rl.launch_compare \\\n")
    lines.append("    --config lab/rl/cfg/compare_v0.yaml --max-parallel 6\n\n")
    lines.append("# aggregate\n")
    lines.append("lab/rl/.rl_venv/Scripts/python.exe -m lab.rl.aggregate_compare \\\n")
    lines.append("    --config lab/rl/cfg/compare_v0.yaml\n\n")
    lines.append("# inspect curves\n")
    lines.append("lab/rl/.rl_venv/Scripts/python.exe -m tensorboard.main --logdir logs/tb_logs/compare_v0\n")
    lines.append("```\n")
