...
Diffs to `lab/rl/envs/hover_pid_tuner_v0.py`.
...
### 3a. New module `lab/rl/bridge_client.py`
...
### 3c. New module `lab/rl/crash_recovery.py`

```python
import logging, time, math
from pymavlink import mavutil
from lab.rl.bridge_client import BridgeClient
