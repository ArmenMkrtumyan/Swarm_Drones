...
Sister tool of capstone.control.benchmark_hover; same role, different stage.
...
Usage:
    ...
    python -m capstone.missions.benchmark_mission \\
        capstone/missions/cases/square_20m.yaml --runs 10
    ...
    # Single run + plots
    python -m capstone.missions.benchmark_mission \\
        capstone/missions/cases/square_20m.yaml --runs 1
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.runs > 0:
        ...
        from capstone.missions.runner import run_mission
