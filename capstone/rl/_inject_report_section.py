...
def main():
    ...
    additions.append(_new_paragraph(doc,
        ...
        "Swarm_Drones/capstone/rl/. The full experiment can be reproduced "
        "end-to-end with two commands:"))
    additions.append(_new_paragraph(doc,
        "    python -m capstone.rl.launch_compare --config capstone/rl/cfg/compare_v0.yaml --max-parallel 6", style="normal"))
    additions.append(_new_paragraph(doc,
        "    python -m capstone.rl.aggregate_compare --config capstone/rl/cfg/compare_v0.yaml", style="normal"))
    additions.append(_new_paragraph(doc,
