...
Run from the .rl_venv with capstone/ on PYTHONPATH:

    cd Swarm_Drones
    capstone/rl/.rl_venv/Scripts/python.exe -m capstone.rl.train_hover \
...
from capstone.rl.config_loader import LoadedConfig, load_config
from capstone.rl.envs.hover_pid_tuner_v0 import HoverPidTunerEnv


log = logging.getLogger("capstone.rl.train")
...
def main() -> None:
    ...
    ap.add_argument("--config", required=True, type=str,
                    help="path to YAML config (e.g. capstone/rl/cfg/hover_v0.yaml)")
