...
Usage:
    ...
    cd Swarm_Drones
    capstone/rl/.rl_venv/Scripts/python.exe -m capstone.rl.train_pretrain \\
        --config capstone/rl/cfg/pretrain_v0.yaml
...
Open TensorBoard:
    ...
    capstone/rl/.rl_venv/Scripts/python.exe -m tensorboard.main --logdir logs/tb_logs
"""
...
log = logging.getLogger("capstone.rl.train_pretrain")
