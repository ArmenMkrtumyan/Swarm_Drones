...
Sequentially runs `tools/bo_search.run_one(...)` for each controller, writes
...
Usage:
    python3 tools/bo_all.py --n-trials 30
    python3 tools/bo_all.py --n-trials 30 --only stc,pso,boustrophedon
"""
...
from tools.bo_search import CONTROLLERS, run_one
