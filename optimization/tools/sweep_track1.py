"""
Multi-axis sweep for Track 1 classical / geometry-based controllers.

Companion to `tools/sweep.py` (Track 3) and `tools/sweep_track2.py`
...
Each controller's defaults come from its `tools/grid_search_{algo}.py`
top-1 result.

Outputs:
    outputs/sweep_track1_results.csv
    outputs/sweep/png/sweep_track1_{coverage_vs_drones,time_to_80_vs_drones,
                                   efficiency_vs_drones,curves_grid}.png
    outputs/sweep/svg/sweep_track1_{...}.svg

Usage:
    python tools/sweep_track1.py
"""
...
def main():
    ...
    csv_path = OUTPUTS_DIR / "sweep_track1_results.csv"
    ...
    plot_specs = [
        ("sweep_track1_coverage_vs_drones",  plot_coverage_vs_drones),
        ("sweep_track1_time_to_80_vs_drones", plot_time_to_80_vs_drones),
        ("sweep_track1_efficiency_vs_drones", plot_efficiency_vs_drones),
        ("sweep_track1_curves_grid",          plot_curves_grid),
    ]
