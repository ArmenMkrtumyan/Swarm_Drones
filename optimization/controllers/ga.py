...
class GAConfig:
    ...
    elite_fraction: float = 0.40          # top fraction kept untouched
    p_crossover: float = 0.10             # prob non-elite adopts elite-derived target
    p_mutation: float = 0.30              # prob non-elite jumps to random nearby uncov cell
